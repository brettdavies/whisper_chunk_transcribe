...
class LoggerConfig:
    @staticmethod
    def setup_logger(log_name: str, log_file_dir: str = "./data/log/", log_level: str = "INFO", log_file_prefix: str = "") -> None:
        """
        ...
        if log_file_path.exists():
            ...
            new_log_file_path = Path(log_file_dir) / f"{log_file_prefix}{log_name}_{timestamp}.log"
            try:
